...
const Cards = () => {
    const data = [
        ...
        {image: "https://raw.githubusercontent.com/GDSCCarleton/GDSCCarleton.github.io/main/images/nishtha.jpg", name: "Nishta M.", title: "Project Coordinator", color: '#FBBC04', linkedin: 'https://www.linkedin.com/in/nishthamavai/'},
    ...
    const cardDetails = (props: CardDetailsProps) => {
        return(
        <div style={{ display: 'flex',  paddingLeft: '30px', paddingBottom: '30pxgi' }}>
        <Card style={{width: '13rem', height: '20rem', display:'flex', alignItems: 'center',  justifyContent: 'center', border: `2px solid ${props.color}`, fontFamily:"Poppins"}}>
